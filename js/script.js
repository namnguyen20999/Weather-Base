...
function getResults(cityName) {
    ...
    request.onload = function(){
        ...
        var iconURL1800 = `https://openweathermap.org/img/wn/${dataParsed.list[1].weather[0].icon}.png`;
        ...
        var iconURL2100 = `https://openweathermap.org/img/wn/${dataParsed.list[2].weather[0].icon}.png`;
        ...
        var iconURL0000 = `https://openweathermap.org/img/wn/${dataParsed.list[3].weather[0].icon}.png`;
        ...
        var iconURL0300 = `https://openweathermap.org/img/wn/${dataParsed.list[4].weather[0].icon}.png`;
        ...
        var iconURL0600 = `https://openweathermap.org/img/wn/${dataParsed.list[5].weather[0].icon}.png`;
        ...
        var iconURL0900 = `https://openweathermap.org/img/wn/${dataParsed.list[6].weather[0].icon}.png`;
        ...
        var iconURL1200 = `https://openweathermap.org/img/wn/${dataParsed.list[7].weather[0].icon}.png`;
        ...
        var iconURL1500 = `https://openweathermap.org/img/wn/${dataParsed.list[8].weather[0].icon}.png`;
